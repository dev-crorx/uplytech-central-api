...
router.get('/search', authenticate as never, (req, res, next) => ipController.search(req, res, next));
...
router.patch('/:id', authenticate as never, auditLog('UPDATE', 'ip') as never, (req, res, next) => ipController.update(req, res, next));
