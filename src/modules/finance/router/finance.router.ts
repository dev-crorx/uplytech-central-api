...
router.get('/search', authenticate as never, (req, res, next) => financeController.search(req, res, next));
...
router.patch('/:id', authenticate as never, auditLog('UPDATE', 'finance') as never, (req, res, next) => financeController.update(req, res, next));
