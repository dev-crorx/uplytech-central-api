...
router.get('/search', authenticate as never, (req, res, next) => docsController.search(req, res, next));
...
router.patch('/:id', authenticate as never, auditLog('UPDATE', 'docs') as never, (req, res, next) => docsController.update(req, res, next));
